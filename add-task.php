...
<body>
 ...
 <div class="container">
     ...
     if(isset($_POST['taskId'])) {
       echo "<br><br><br><br><span style='color:black'><b>Added task #".$_POST['taskId']. ": ".$_POST["taskDescription"]."</b></span>";
     } else {
       ...
       <div class="col-75">
          <input type="text" name="taskDescription" id="assetType" placeholder="Cleaning, Maintenance etc." required />
       </div>
       </div>
         <div>
     ...
     if(isset($_POST['submit'])) {
       ...
       $sql = "INSERT INTO `task`(`task-id`, `task-description`) VALUES ('".$_POST['taskId']."', '".$_POST['taskDescription']."')";
