...
<body>
 ...
 <div class="container">
     ...
     if(isset($_POST['assetId'])) {
       echo "<br><br><br><br><span style='color:black'><b>Added asset #".$_POST['assetId']. ": ".$_POST["assetDescription"]."</b></span>";
     } else {
       ...
       <div class="col-75">
          <input type="text" name="assetDescription" id="assetType" placeholder="Table / Chair / Machine etc." required />
       </div>
       </div>
         <div>
     ...
     if(isset($_POST['submit'])) {
       ...
       $sql = "INSERT INTO `asset`(`asset-id`, `asset-description`) VALUES ('".$_POST['assetId']."', '".$_POST['assetDescription']."')";
