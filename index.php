...
<body>
 ...
 <div class="container">
 	<div class="row">
 		<div class="col-lg-12">
 			<div class="content">
 				<h1>The House Keeping API</h1>
 				<h3>Application Program Interface for Task Management!</h3>
 				<hr>
 				<button class="btn btn-default btn-lg"><i class="fa fa-check"></i> Let's Get Started!</button>
 			</div>
 		</div>
 	</div>
 </div>
